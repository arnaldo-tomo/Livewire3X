<div>
    ...
    <div id="hs-notifications"
        class="hs-overlay mt-20  size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog"
        tabindex="-1" aria-labelledby="hs-notifications-label">
        <div
            class="m-3 mt-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:max-w-lg sm:w-full sm:mx-auto">
            <div
                class="relative flex flex-col overflow-hidden bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
                <div class="absolute top-2 end-2">
                    <button type="button"
                        ...
                        aria-label="Close" data-hs-overlay="#hs-notifications">
                ...
                <div class="p-4 overflow-y-auto sm:p-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            <label for="hs-account-activity" class="flex p-4 gap-x-5 md:p-5">
                                <span class="flex gap-x-5">
                                    <svg class="mt-1 text-gray-500 shrink-0 size-5 dark:text-neutral-500"
                                    ...
                                    <span class="grow">
                                        <span class="block font-medium text-gray-800 dark:text-neutral-200">Account
                                            Activity</span>
                                        <span class="block text-sm text-gray-500 dark:text-neutral-500">Get important
                                            notifications about you or activity you've missed</span>
                                    </span>
                                </span>

                                <input type="checkbox" id="hs-account-activity"
                    ...
                    before:inline-block before:size-6 before:bg-white checked:before:bg-blue-200 before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-blue-200"
                        ...
                        <div
                            class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
                            <label for="hs-meetups-near-you" class="flex p-4 gap-x-5 md:p-5">
                                <span class="flex gap-x-5">
                                    <svg class="mt-1 text-gray-500 shrink-0 size-5 dark:text-neutral-500"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <span class="grow">
                                        <span class="block font-medium text-gray-800 dark:text-neutral-200">Meetups Near
                                            You</span>
                                        <span class="block text-sm text-gray-500 dark:text-neutral-500">Get an email
                                            when a Preline Meetup is posted close to my location</span>
                                    </span>
                                </span>
                    ...
                    before:inline-block before:size-6 before:bg-white checked:before:bg-blue-200 before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-blue-200">
                        ...
                        <div
                            class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
                            <label for="hs-preline-communication" class="flex p-4 gap-x-5 md:p-5">
                                <span class="flex gap-x-5">
                                    <svg class="mt-1 text-gray-500 shrink-0 size-5 dark:text-neutral-500"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <span class="grow">
                                        <span class="block font-medium text-gray-800 dark:text-neutral-200">Preline
                                            Communication</span>
                                        <span class="block text-sm text-gray-500 dark:text-neutral-500">Get Preline
                                            news, announcements, and product updates</span>
                                    </span>
                                </span>

                                <input type="checkbox" id="hs-preline-communication"
                                    class="relative w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none  dark:bg-neutral-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800
                ...
                <div
                    class="flex items-center justify-end px-4 py-3 border-t gap-x-2 bg-gray-50 dark:bg-neutral-950 dark:border-neutral-800">
                    <button type="button"
        ...
        <x-slot name="header">
            <ol class="flex items-center whitespace-nowrap">
                ...
                <li class="inline-flex items-center py-1.5 px-2 text-sm font-semibold text-gray-800 truncate dark:text-neutral-200"
                    aria-current="page">
                    <a href="{{ URL('contact') }}" wire:navigate>Contacto</a>
                </li>
            </ol>
        </x-slot>
