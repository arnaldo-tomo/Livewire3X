        ...
        <div class="p-4 sm:p-7">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
              ...
              <a class="font-medium text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline dark:text-blue-500" href="register">
                Sign in here
              </a>
            </p>
          </div>
          ...
          <div class="mt-5">
            ...
            <div class="flex items-center py-3 text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-800 dark:after:border-neutral-800">Or</div>

            <!-- Form -->
    <!-- Session Status -->
    {{-- <x-application-logo class="relative w-2/12 text-gray-800 fill-current place-items-end place-content-end dark:text-gray-200" /> --}}
